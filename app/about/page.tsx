  ...
  return (
    <main className="text-white py-5 px-5 md:px-8 lg:px-16 xl:px-24 2xl:px-32 text-justify">
      ...
      <p className="text-lg mb-6">
        ...
        world of movies! 🎬✨ Whether you&apos;re a lifelong film fanatic, a
        curious movie explorer, or someone seeking inspiration through the magic
        of cinema, you&apos;ve found the right place.
        <br />
        ...
        telling, and every viewer has a story to share. At{" "}
        <span className="text-red-500">G Movies App</span>, we make it our
        priority to create a platform where everyone, from casual viewers to
        industry professionals, feels at home.
      </p>
      ...
      <AboutSections
        title="Who We Are"
        paragraphs={[
          `At our core, <span class="text-red-500">G Movies App</span> is driven by a passion for cinema. We are a group of storytellers, tech enthusiasts, and movie buffs united by the shared love of films. Our diverse team brings together expertise in technology, content creation, and community building to create a space where cinema can truly shine.`,
          `We believe that movies are more than just entertainment—they&apos;re a reflection of our lives, emotions, and cultures. That&apos;s why we&apos;ve made it our mission to provide a platform that celebrates the art of filmmaking while making it accessible to people from all walks of life. Our journey started with a dream, and today, we are proud to be a hub for movie lovers worldwide.`,
        ]}
      />
      <AboutSections
        title="What We Do"
